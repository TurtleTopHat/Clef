...
function play_chord(chord_button){
  ...
  var note_playing1 = new Audio('notes/' + notes_of_chord[0] + '4.mp3');
  var note_playing2 = new Audio('notes/' + notes_of_chord[1] + '4.mp3');
  var note_playing3 = new Audio('notes/' + notes_of_chord[2] + '4.mp3');

  var note_highlight1 = notes_of_chord[0] + "key";
  var note_highlight2 = notes_of_chord[1] + "key";
  var note_highlight3 = notes_of_chord[2] + "key";

  document.getElementById(note_highlight1).classList.add('active')
  document.getElementById(note_highlight2).classList.add('active')
  document.getElementById(note_highlight3).classList.add('active')
  setTimeout(() => {
    note_playing1.play();
    note_playing2.play();
    note_playing3.play();
    document.getElementById(note_highlight1).classList.remove('active')
    document.getElementById(note_highlight2).classList.remove('active')
    document.getElementById(note_highlight3).classList.remove('active')
  }, 500);
...
function keyPlay(press){
  ...
  key_playing.play();
  press = press+'key';
  document.getElementById(press).classList.add('active');
  setTimeout(() => {
    document.getElementById(press).classList.remove('active');
  }, 300);
}
